...
export interface Cluster { id: number; label: string | null; size: number; sample_messages: string[] | null; llm_summary: string | null; llm_confidence: string | null; summary_cached_at: string | null; created_at: string; anomaly_count: number; anomaly_pct: number; }
